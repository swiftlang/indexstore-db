...
#include <IndexStoreDB_LLVMSupport/llvm_ADT_ilist_base.h>
#include <IndexStoreDB_LLVMSupport/llvm_ADT_ilist_iterator.h>
#include <IndexStoreDB_LLVMSupport/llvm_ADT_ilist_node.h>
#include <IndexStoreDB_LLVMSupport/llvm_ADT_ilist_node_options.h>
